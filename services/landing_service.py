...
{{
    "reply": "your helpful response using only the information above",
    "status": "success"
}}

⚠️ Use ONLY the exact information provided above. Do not invent features, pricing, or details.""")
        ...
        try:
            ...
            return {"reply": result.get("reply", "I couldn't process that. Please try again."), "status": "success", "tokens": tokens_used}
